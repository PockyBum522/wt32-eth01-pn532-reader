...
bool Adafruit_PN532::shutDown()
{
    ...
    pn532_packetbuffer[2] = 0x00; // To enable the IRQ, 0x00 if you dont want to use the IRQ

    spi_dev->write(pn532_packetbuffer, 3);

    // read data packet
    readdata(pn532_packetbuffer, sizeof(pn532_packetbuffer));

    delay(3);	//Delay to make sure the module is off.
